...
public class KeyBlockImpl extends ASTWrapperPsiElement implements KeyBlock {

  public KeyBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public KeyStatements getStatements() {
    return findNotNullChildByClass(KeyStatements.class);
  }
