...
public class KeyAssignSingleImpl extends ASTWrapperPsiElement implements KeyAssignSingle {

  public KeyAssignSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KeyVisitor visitor) {
    visitor.visitAssignSingle(this);
  }
